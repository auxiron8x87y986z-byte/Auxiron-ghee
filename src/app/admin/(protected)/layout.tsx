    ...
    <div style={{ display: 'flex', minHeight: '100vh', backgroundColor: '#F9FAFB' }}>
      ...
      <aside style={{ width: '250px', backgroundColor: 'var(--color-surface)', borderRight: '1px solid var(--color-border)', display: 'flex', flexDirection: 'column' }}>
        ...
        <nav style={{ padding: '1.5rem', display: 'flex', flexDirection: 'column', gap: '0.5rem', flex: 1 }}>
          ...
          <Link href="/admin/about" style={{ padding: '0.75rem 1rem', borderRadius: 'var(--radius-sm)', color: 'var(--color-text)', display: 'block', fontWeight: 500 }}>
            About Us
          </Link>
          ...
          <Link href="/admin/home-sections" style={{ padding: '0.75rem 1rem', borderRadius: 'var(--radius-sm)', color: 'var(--color-text)', display: 'block', fontWeight: 500 }}>
            🏠 Home Sections
          </Link>
          <Link href="/admin/settings/general" style={{ padding: '0.75rem 1rem', borderRadius: 'var(--radius-sm)', color: 'var(--color-text)', display: 'block', fontWeight: 500 }}>
            ⛭ Hero Section
          </Link>
          ...
          <Link href="/admin/customers" style={{ padding: '0.75rem 1rem', borderRadius: 'var(--radius-sm)', color: 'var(--color-text)', display: 'block', fontWeight: 500 }}>
            🛍️ Customers
          </Link>
          ...
          <Link href="/admin/settings/smtp" style={{ padding: '0.75rem 1rem', borderRadius: 'var(--radius-sm)', color: 'var(--color-text)', display: 'block', fontWeight: 500 }}>
            📧 SMTP Settings
          </Link>
        </nav>
