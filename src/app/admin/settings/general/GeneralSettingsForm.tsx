...
export default function GeneralSettingsForm({ initialLogo, initialTagline, initialHeroBg }: { initialLogo: string, initialTagline: string, initialHeroBg: string }) {
  ...
  return (
    <div style={{ backgroundColor: 'var(--color-surface)', padding: '2rem', borderRadius: 'var(--radius-md)', boxShadow: 'var(--shadow-sm)', maxWidth: '800px' }}>
      ...
      <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '2rem' }}>
        ...
        <div style={{ borderBottom: '1px solid var(--color-border)', paddingBottom: '2rem' }}>
          <h2 style={{ fontSize: '1.25rem', marginBottom: '1rem' }}>Hero Background Image</h2>
          <p style={{ color: 'var(--color-text-light)', marginBottom: '1rem', fontSize: '0.9rem' }}>
            This is the large background image on the top of your homepage. If removed, the site will use the default image.
          </p>
          ...
          {heroBgPreviewUrl ? (
            ...
            <div style={{ marginBottom: '1rem' }}>
              <input 
                ...
                style={{ padding: '0.5rem', border: '1px solid var(--color-border)', borderRadius: '4px', width: '100%', maxWidth: '400px' }}
              />
              <small style={{ color: 'var(--color-text-light)', display: 'block', marginTop: '0.5rem' }}>Max size: 2MB. Recommended format: High resolution JPG or WebP.</small>
            </div>
          )}
        </div>
